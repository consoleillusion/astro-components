...
schema1["properties"]["global"] = {type: 'array', items: { type: 'string', enum: Object.keys(components) }}
schema1["properties"]["blocks"] = BlockComponentList
export const Webpage = await loadFile(schema1)
